...
export default class ActivateLinuxPreferences extends ExtensionPreferences {
    fillPreferencesWindow(window) {
        ...
        if (parsed) colorButton.set_rgba(initialRgba);
        ...
        fontColorRow.connect('notify::text', () => {
            ...
            if (newRgba.parse(currentText)) colorButton.set_rgba(newRgba);
        });
        ...
        colorButton.connect('notify::rgba', () => {
            ...
            if (rgba) {
                ...
                if (cssStr !== fontColorRow.text) fontColorRow.text = cssStr;
            }
        });
